                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('notes.store', $classroom_id) }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                            ...
                                            <div class="modal fade" id="doc_{{ $req->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <ul class="list-group">
                                                                @foreach($documents[$req->note_img_id] as $doc)
                                            ...
                                            <div class="modal fade" id="EditAn_{{ $req->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('notes.update', $req->id) }}" method="post" enctype="multipart/form-data">
                                                                @csrf
                                                                @method("put")
                                                                <div class="form-group">
                                                                    <label for="exampleInputEmail1">Title</label>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form action="{{ route('notes.destroy', $req->id) }}" method="post">
                                                                @csrf
                                                                @method('delete')
