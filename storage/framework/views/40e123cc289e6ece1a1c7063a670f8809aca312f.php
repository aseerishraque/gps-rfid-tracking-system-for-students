  ...
  <script>
    ...
    function initMap() {
      ...
      function fetchStudentGpsData(){
          ...
          let fetch_api = ''
          if (is_checked){
              fetch_api = "<?php echo e(URL::to('api/v1/fetch-rfid-gps-data')); ?>";
          }else{
              fetch_api = "<?php echo e(URL::to('api/v1/fetch-gps-data')); ?>";
          }
...
//Clear/Remove all markers
 ...
 //each is_instide(Student_location, polygon_co_ord_event_obj)
        ...
        axios.post("<?php echo e(URL::to("api/v1/store-student-gps-attendance/".$classroom_id)); ?>", {
            "date" : attd_date,
            "students" : attd_std
        })
          .then(res=>{
...
<?php /**PATH F:\gps-rfid-tracking-system-for-students\resources\views/includes/gmaps/scripts.blade.php ENDPATH**/ ?>