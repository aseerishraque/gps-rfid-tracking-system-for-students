            ...
            <div class="card">
                <div class="card-body bg1">
                    ...
                    <div class="testimonial-carousel owl-carousel">
                        <div class="tst-item">
                            <div class="tstu-img">
                                <img src="<?php echo e(asset('assets/images/team/team-author1.jpg')); ?>" alt="author image">
                            </div>
                        ...
                        <div class="tst-item">
                            <div class="tstu-img">
                                <img src="<?php echo e(asset('assets/images/team/team-author2.jpg')); ?>" alt="author image">
                            </div>
                            <div class="tstu-content">
                                <h4 class="tstu-name">Abel Franecki</h4>
                                <span class="profsn">Designer</span>
                        ...
                        <div class="tst-item">
                            <div class="tstu-img">
                                <img src="<?php echo e(asset('assets/images/team/team-author3.jpg')); ?>" alt="author image">
                            </div>
                            <div class="tstu-content">
                                <h4 class="tstu-name">Abel Franecki</h4>
                                <span class="profsn">Designer</span>
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\gps-rfid-tracking-system-for-students\resources\views/pages/admin-dashboard.blade.php ENDPATH**/ ?>